...
import com.example.golferschoice.utils.AppUser;
        ...
        tv_updateuserdetail.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                ...
                if (TextUtils.isEmpty(username)){
                    Toast.makeText(ProfileActivity.this, "Please fill in your name", Toast.LENGTH_LONG).show();
                    return;
                }
                if (TextUtils.isEmpty(useremail)){
                    Toast.makeText(ProfileActivity.this, "Please fill in your email", Toast.LENGTH_LONG).show();
                    return;
                }
                        ...
                        .addOnCompleteListener(new OnCompleteListener<Void>() {
                            ...
                            public void onComplete(@NonNull  Task<Void> task) {
                                if (task.isSuccessful()){
                                    ...
                                    Toast.makeText(ProfileActivity.this, "Nice work, welcome aboard !", Toast.LENGTH_SHORT).show();
                                    startActivity(new Intent(ProfileActivity.this, MainActivity.class));
                                    finish();
                                }else{
                                    progressbar.setVisibility(View.GONE);
                                    Toast.makeText(ProfileActivity.this, "Oh no, please try again...", Toast.LENGTH_SHORT).show();
                                }
                            }
                        });
            }
